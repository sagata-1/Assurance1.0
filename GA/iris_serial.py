...
def main():
    ...
    # Read in the data
    dict_conversion = {"Iris-setosa": 1, "Iris-versicolor": 2, "Iris-virginica": 3}
    reverse_conversion = {1: "Iris-setosa", 2: "Iris-versicolor", 3:"Iris-virginica" }
    ...
    # print(predictions)
    inputData["Predictions"] = predictions
    result = inputData[["Species", "Predictions"]]
    accuracy = accuracy_score(inputData["Species"], inputData["Predictions"])
